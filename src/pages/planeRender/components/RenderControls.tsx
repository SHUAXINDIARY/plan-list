                ...
                >
                    ...
                    <div className="plane-render__render-fields">
                        <label className="plane-render__render-field">
                            <span>画质预设</span>
                            <select value={settings.qualityPreset} onChange={onQualityPresetChange}>
                        ...
                        <label className="plane-render__render-field">
                            ...
                            <select
                                ...
                                disabled={
                                    settings.environmentPreset !== "hdri" || hdriAssets.length === 0
                                }
                                onChange={onHdriChange}
                            >
                                <option value="">
                                    {hdriAssets.length === 0 ? "hdri 目录为空" : "选择 HDRI 环境"}
                                </option>
                                {hdriAssets.map((asset: AircraftHdriAsset): ReactElement => (
                        ...
                        <label className="plane-render__render-field">
                            <span>色调映射</span>
                            <select value={settings.toneMapping} onChange={onToneMappingChange}>
                        ...
                        <p className="plane-render__render-section-label">光源位置</p>
                        <label className="plane-render__render-field plane-render__render-field--range">
                            <span>
                                主光强度
