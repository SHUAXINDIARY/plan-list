...
export const MAP_ROUTES: MapRoute[] = [
  ...
  createMapRoute('普吉至曼谷（素万那普）', '普吉国际机场', '曼谷素万那普国际机场', 'international'),
  createMapRoute('曼谷（素万那普）至首都', '曼谷素万那普国际机场', '北京首都国际机场', 'international'),
  createMapRoute('首都至曼谷（素万那普）', '北京首都国际机场', '曼谷素万那普国际机场', 'international'),
  ...
  createMapRoute('上海（浦东）至巴塞罗那', '上海浦东国际机场', '巴塞罗那埃尔普拉特机场', 'international'),
  createMapRoute('巴塞罗那至罗马', '巴塞罗那埃尔普拉特机场', '罗马菲乌米奇诺机场', 'international'),
  createMapRoute('罗马至巴黎（奥利）', '罗马菲乌米奇诺机场', '巴黎奥利机场', 'international'),
  createMapRoute('巴黎（奥利）至卡萨布兰卡', '巴黎奥利机场', '卡萨布兰卡穆罕默德五世机场', 'international'),
  createMapRoute('卡萨布兰卡至首都', '卡萨布兰卡穆罕默德五世机场', '北京首都国际机场', 'international'),
