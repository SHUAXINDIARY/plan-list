...
const AnnotatedWorldMap = ({
    ...
    const resolvedInternationalRouteLegendLabel = routeLegendLabel ?? internationalRouteLegendLabel;
    ...
    useEffect((): (() => void) | undefined => {
        const themeObserver = new MutationObserver((): void => {
            ...
            setViewportTransform((current: ViewportTransform): ViewportTransform => ({
                ...current,
            }));
        });
