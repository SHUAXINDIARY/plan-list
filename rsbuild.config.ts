        ...
        tags: [
            {
                ...
                head: true,
                append: false,
                children: `(function(){try{var k='plane-list-theme';var t=localStorage.getItem(k);document.documentElement.setAttribute('data-theme',t==='dark'?'dark':'light');}catch(e){document.documentElement.setAttribute('data-theme','light');}})();`,
            },
        ],
    },
    tools: {
